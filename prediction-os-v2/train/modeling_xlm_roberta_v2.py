...
from modeling_roberta_v2 import (
    RobertaForMaskedLM,
    RobertaForMultipleChoice,
    RobertaForQuestionAnswering,
    RobertaForQuestionAnswering_v2,
    RobertaForQuestionAnswering_v3,
...
class XLMRobertaForQuestionAnswering_v2(RobertaForQuestionAnswering_v2):
    """
    This class overrides :class:`~transformers.RobertaForQuestionAnswering`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
...
class XLMRobertaForQuestionAnswering_v3(RobertaForQuestionAnswering_v3):
    """
    This class overrides :class:`~transformers.RobertaForQuestionAnswering`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
